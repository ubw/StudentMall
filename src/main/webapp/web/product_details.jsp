...
<div id="shop_detail">
    ...
    <div id="preview" class="lf">
        <div id="mediumDiv">
            <img id="mImg" src="${pageContext.request.contextPath}${goods.image}"/>
            <input type="hidden" id="goodsId" name="goodsId" value="${goods.id}"/>
            <input type="hidden" id="goodsImg" name="goodsImg" value="${goods.image}"/>
        </div>
        <div id="icon_all">
            <ul id="icon_list">
    ...
    <div class="right_detail lf">
        <!-- 商品名称-->
        <h1 id="goodsItemType">${goods.itemType}</h1>
        <!-- 商品全称-->
        <h3 id="goodsTitle">(${goods.title})</h3>
        <!-- 价格部分-->
        <div class="price">
            <div id="pro_price"><b>学员售价：</b>￥<span id="goodsPrice">${goods.price}</span>.00</div>
            <div class="promise">
                <b>服务承诺：</b>
                <span>*退货补运费</span>
                <span>*30天无忧退货</span>
        ...
        <p>
            <span>规格：</span>
            <ul>
                <c:forEach items="${goodsList}" var="itemTypeGoods">
                    <li class="avenge">
                        <a href="../goods/showDetail.do?id=${itemTypeGoods.id}" <c:if test="${itemTypeGoods.id == goods.id}">class="current" </c:if>>
                            ${itemTypeGoods.title}
                        </a>
                    </li>
                </c:forEach>
        ...
        <div class="shops">
            ...
            <a href="#" class="shop lf" id="add_cart"><img src="../images/product_detail/product_detail_img7.png" alt="" onclick="foo()"/>加入购物车</a>
...
<script type="text/javascript">
    ...
    $("#add_cart").click(function () {
        ...
        var data = {"goodsId":$("#goodsId").val(),
            "goodsImage":$("#goodsImg").val(),
            "goodsTitle":$("#goodsTitle").text(),
            "goodsItemType":$("#goodsItemType").text(),
            "goodsPrice":$("#goodsPrice").text(),
            "goodsCount":$("#buy-num").val()};
        console.log(data);
        alert("停顿看data");
        $.ajax({
            "url":url,
