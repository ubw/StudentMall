    ...
    <div class="adress_choice">
        ...
        <div id="addresId1" class="base_select">
            ...
            <i class="user_address">
                    ${address.recvDistrictProvince}${address.recvDistrictCity}${address.recvDistrictArea}${address.recvAddr}
            </i>
    ...
    <form name="" method="post" action="#">
        <div class="product_confirm">
            ...
            <ul class="item_detail">
                <li class="p_info">
                    <b><img src="${pageContext.request.contextPath}${cart.goodsImage}" style="width: 100px"/></b>
        ...
        <div class="rs_content rs_content_1">
        	...
        	<form method="post" action="">
	            ...
	            <div class="address_postcode">
	                <span class="red">&nbsp;</span ><span class="kuan">邮政编码：</span>&nbsp;<input type="text" name="receiverZip"/>
	            </div>
	            <!--地址名称-->
	            <div class="address_name">
	                <span class="red">&nbsp;</span ><span class="kuan">地址名称：</span>&nbsp;<input type="text" id="addressName" name="addressName"/>如：<span class="sp">家</span><span class="sp">公司</span><span class="sp">宿舍</span>
	            </div>
	            <!--保存收货人信息-->
