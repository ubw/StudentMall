    ...
    <div class="lf1_bottom">
        <div class="item_cat lf">
            ...
            <div class="item_cat_all">
                    <c:forEach items="${computerLvlTwoList}" var="two" varStatus="i">
                        <p>${two.name}</p>
                        <ul>
                            <c:forEach items="${computerLvlThreeList[i.index]}" var="three">
                                <li><a href="../goods/list.do?categoryId=${three.id}">${three.name}</a></li>
                            </c:forEach>
                        </ul>
                    </c:forEach>
            </div>
        ...
        <c:forEach items="${goodsList}" var="good">
            <div class="item_msg lf">
                ...
                <p class="bottom_ys2">${good.title}</p>
                <p class="bottom_ys3">${good.price}</p>
                <p class="bottom_ys4 color_2"><a href="#${good.id}">查看详情</a></p>
            </div>
        </c:forEach>
</div>
<!--楼梯2f-->
