...
<div id="container" class="clearfix">
    ...
    <div class="rightsidebar_box rt">
        <div class="rs_header">
            <span class="rs_header_active"><a href="personalinfo.do">我的信息</a></span>
        ...
        <div class="rs_content">
            <form id="personalinfo">
                ...
                <div class="rs_content_username">
                    ...
                    <input id="username" name="username" class="ed_username" value="${user.userName}"/>
                </div>
                <!--性别 单选框name可以相同，id不同-->
                ...
                <div class="rs_content_tel">
                    ...
                    <input id="phone" name="phone" class="ed_phone" value="${user.phone}"/>
                </div>
                <!--绑定邮箱-->
                <div class="rs_content_mail">
                    <span class="same">绑定邮箱：</span>
                    <input id="email" name="email" class="ed_email"  value="${user.email}"/>
                </div>
                <!--保存按钮-->
                <div class="save" onclick="editPersonalInfo()">
                    保存更改
                </div>
            </form>
        </div>
...
<script type="text/javascript">
    function editPersonalInfo(){
        var url = "../usr/handle_edit_userinfo.do";
        ...
        $.ajax({
            ...
            "success":function (obj) {
                ...
                if (obj.state == 0){
                    alert("更新成功");
                    location.href="../usr/handle_personalinfo.do";
                }
            },
            "error":function () {
                alert("更新失败");
