        ...
        <div id="box" >
            <div id="content_box">
                ...
                <div class="imfor">
                    <div class="check">
                        <div class="Each">
                            <span class="normal" name="checkboxFoo" id="checkboxFoo" onclick="foo(${cart.id})">
                                <img src="../images/cart/product_normal.png" alt=""/>
                            </span>
                            <input type="hidden" name="" value="${cart.goodsId}">
                        </div>
                    </div>
                    <div class="pudc">
                        <div class="pudc_information" id="pudcId3">
                            <img src="${pageContext.request.contextPath}${cart.goodsImage}" class="lf" style="width:100px"/>
                            <input type="hidden" name="" value="">
                        <span class="des lf">
                            ${cart.goodsTitle}
                              <input type="hidden" name="" value="">
                        </span>
                            <p class="col lf"><span>规格：</span><span class="color_des">${cart.goodsItemType}  <input type="hidden" name="" value=""></span></p>
                        </div>
                    </div>
                    <div class="pices">
                    ...
                    <div class="totle">
                        <span>￥</span>
                        <span class="totle_information">${cart.goodsCount*cart.goodsPrice}.00</span>
                    </div>
                    <div class="del">
                        <!-- <div>
            ...
            <div class="foot">
                ...
                <div class="foot_cash" id="go-buy">
                    <form method="get" action="../order/list.do">
                        <input type="hidden" id="goodsIdParam" name="goodsIdParam" value=""/>
...
<script>
    ...
    function foo(id) {
        setTimeout(function()
        {
            console.log("begin goodsIdParam:"+goodsIdParam);
            //清空goodsIdParam
            goodsIdParam = "";

            //id="checkboxFoo" 的 <span> 元素中的所有 class="true" 的元素
            $("span.true").each(function() {
                if (goodsIdParam == "") {
                    goodsIdParam += $(this).next().val();
                } else {
                    goodsIdParam +=",";
                    goodsIdParam += $(this).next().val();
                }
                $("#goodsIdParam").val(goodsIdParam);
                console.log($("#goodsIdParam").val());
            });
           console.log("end goodsIdParam:"+goodsIdParam);
       },300);
    }
