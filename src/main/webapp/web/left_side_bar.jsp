...
<div id="leftsidebar_box" class="lf">
    ...
    <dl class="address">
        ...
        <dd><form method="post" action="../address/list_address_info.do"><input type="submit" value="收获地址"></form></dd>
    </dl>
    <dl class="count_managment">
        <dt >帐号管理<img src="../images/myOrder/myOrder1.png"></dt>
        <dd class="first_dd"><a href="../usr/personalinfo.do">我的信息</a></dd>
        <dd><a href="../usr/password.do">安全管理</a></dd>
    </dl>
</div>
